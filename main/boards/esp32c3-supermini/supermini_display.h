...
public:
    ...
    virtual void SetupUI() override {
        ...
        // Row 1: Header (Y = 0) - Compact styling
        title_5h_ = lv_label_create(quota_container_);
        lv_obj_set_pos(title_5h_, 4, 0);
        ...
        lv_obj_set_style_text_letter_space(title_5h_, -1, 0);
        ...
        // Row 2: Percentage Text (Y = 12) - Dominant / Largest (20px font)
        label_5h_ = lv_label_create(quota_container_);
        lv_obj_set_pos(label_5h_, 4, 12);
        ...
        lv_obj_set_style_text_font(label_5h_, &font_noto_sans_basic_20_4, 0);
        ...
        // Row 3: Progress Bar (Y = 33, Height = 1px) - 1px Ultra-slim Bar
        bar_5h_ = lv_bar_create(quota_container_);
        lv_obj_set_pos(bar_5h_, 4, 33);
        lv_obj_set_size(bar_5h_, 56, 1);
        ...
        lv_obj_set_style_border_width(bar_5h_, 0, 0);
        lv_obj_set_style_pad_all(bar_5h_, 0, 0);
        ...
        // Row 4: Reset Countdown (Y = 35)
        eta_5h_ = lv_label_create(quota_container_);
        lv_obj_set_pos(eta_5h_, 4, 35);
        ...
        lv_obj_set_style_text_letter_space(title_7d_, -1, 0);
        ...
        lv_obj_set_pos(label_7d_, 68, 12);
        ...
        lv_obj_set_style_text_font(label_7d_, &font_noto_sans_basic_20_4, 0);
        ...
        lv_obj_set_pos(bar_7d_, 68, 33);
        lv_obj_set_size(bar_7d_, 56, 1);
        ...
        lv_obj_set_style_border_width(bar_7d_, 0, 0);
        lv_obj_set_style_pad_all(bar_7d_, 0, 0);
